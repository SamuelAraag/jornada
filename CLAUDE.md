...
**All rules and reference material live inside `00-proxy/`.** Before doing any
work in this repository, read `00-proxy/CLAUDE.md`. Do not assume any rule from
this file alone; if it's not in `00-proxy/`, ask.
...
`00-proxy/mapa.json`, never in this repository. Resolve it there — do not
